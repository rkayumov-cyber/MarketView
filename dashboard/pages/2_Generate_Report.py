...
|------|-------|------------|
| May 1 | FOMC Decision | 🔴 High |
| May 3 | NFP Employment | 🔴 High |
| May 10 | US CPI | 🔴 High |
...
|------|-------|------------|-----------------|
| May 1 | FOMC Decision | 🔴 High | Sets policy direction |
| May 3 | NFP Employment | 🔴 High | Labor market health |
| May 10 | US CPI | 🔴 High | Inflation trajectory |
| May 15 | Retail Sales | 🟡 Medium | Consumer health |
| May 22 | FOMC Minutes | 🟡 Medium | Policy nuance |
